...
{ 
    ...
    protected $posts_type = 'project_owner';
    ...
    {    
      ...
      //dd($model['profile_ability']); 
       return view('manage/project_owner/project_owner_profile',compact('model'));
    }

    public function  project_owner_profile_save(Request $request)
    {    
    ...
    public function  project_owner_post(Request $request)
    {    
      $page_title = $this->page_title;
      $paginate_num = 5;
      $account_id =  session('account')['account_id'];
     ...
     // $model =  $model->RightJoin('upload', 'posts.id', '=', 'upload.posts_id') ;
      ...
      //dd(DB::getQueryLog());  
     //dd($model);
       return view('manage/project_owner/project_owner_post_index',compact('model','page_title'));
    }

    public function  project_owner_post_add(Request $request)
    {    
      $page_title = $this->page_title; 
      $upload = [];
      $account_id =  session('account')['account_id'];
      ...
      return redirect('/manage/project_owner/post/edit?id='. $model->posts_key) ;
     
       // dd($upload);
      // return view('manage/project_owner/project_owner_post_frm',compact('model','page_title' ,'upload'));
    }
    public function  project_owner_post_edit(Request $request)
    {
      $page_title = $this->page_title;
      $account_id =  session('account')['account_id'];
    ...
    public function  project_owner_post_save(Request $request)
    {      
      $model =  [];
      $model_group =  [];  
      $post = $request->input('model');
