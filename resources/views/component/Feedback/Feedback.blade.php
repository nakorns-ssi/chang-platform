  ...
  <div class="container  px-2" style="max-width: 400px">
    ...
    <form action="{{$actionPath}}" method="post" name="frm_n" id="frm_n" enctype="multipart/form-data">
      ...
      <div class="card text-center pt-2 ">  
        ...
        <div class=" rate  mt-2 ">
          @include('component.Feedback.Rating_item',['rating_item'=>'ใช้งานง่าย'])
          @include('component.Feedback.Rating_item',['rating_item'=>'ความรวดเร็ว'])
          @include('component.Feedback.Rating_item',['rating_item'=>'ความน่าเชื่อถือ'])
          @include('component.Feedback.Rating_item',['rating_item'=>'แนะนำเพื่อน']) 
        </div> 

        <div class="rate   px-3 text-start  mt-3"> 
          <label for="remark" class="form-label">แนะนำเพิ่มเติม</label>
          <textarea class="form-control" id="remark" name="model[rating][{{base64_encode('แนะนำเพิ่มเติม')}}]" rows="3"></textarea>
        </div> 
