...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between"> 
        <a class="btn btn-sm  btn-outline-dark" href="/manage"  ><i class="bi bi-caret-left-fill"></i> หน้าจัดการงาน</a>
        <div class="  "><a class="text-dark" href="/manage/project_owner/post">โพสต์ทั้งหมด{{$page_title}} </a> </div>
    </div>
  </header><!-- End Header -->
      ...
      <section class="container  " style="margin-top:25px;"  >  
        <div class="mb-2 row justify-content-between">
            ...
            <div class="col-6  text-end">
                <a class="btn btn-sm btn-primary" href="/manage/project_owner/post/add" role="button"><i class="bi bi-plus-lg"></i> สร้างโพสต์ใหม่</a>
            </div>
        </div>
