...
{{-- @include('manage.manage_header') --}}
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between"> 
        <a class="btn btn-sm  btn-outline-dark" href="/manage/project_owner/post"  ><i class="bi bi-caret-left-fill"></i> ย้อนกลับ</a>
        <div class="  "><a class="text-dark" href="/manage/project_owner/post">โพสต์สำหรับผู้ว่าจ้าง </a> </div>
    </div>
  </header><!-- End Header -->
  <!-- End Header -->
